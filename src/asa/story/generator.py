...
class StoryGenerator:
    ...
    def _structured(self, user: str, model: type, role: str, label: str,
        ...
        try:
            ...
            c2 = self.chain.complete(system, repair, role=role, max_tokens=max_tokens,
    ...
    def scenes(self, outline: StoryOutline, draft: dict, cast: list[dict],
               existing_locations: list[str], sfx_library: list[str]) -> tuple:
        ...
        # often truncated. Budget generously; parse_model salvages a cut-off tail anyway.
